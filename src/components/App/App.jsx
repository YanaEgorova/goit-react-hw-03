...
export default function App() {
  ...
  const onDelete = id => {
    setContacts((allContacts) => (allContacts.filter(contact => contact.id !== id)))
  }

  const visibleContacts = contacts.filter(contact => contact.name.toLowerCase().includes(value.toLowerCase()));
